    ...
    <div className="m-2 grid grid-cols-2 border-b border-gray-900">
      <div
        className={`grid-cols-1 justify-center items-center cursor-pointer transition duration-200 rounded-tr-2xl rounded-tl-2xl ${
          userType === "all" ? "bg-gray-200 dark:bg-gray-700 text-gray-700" : "hover:bg-gray-300 dark:hover:bg-gray-500"
        } p-2 text-center`}
      ...
      <div
        className={`grid-cols-1 justify-center items-center cursor-pointer transition duration-200 rounded-tr-2xl rounded-tl-2xl ${
          userType === "online" ? "bg-gray-200 dark:bg-gray-700 text-gray-700" : "hover:bg-gray-300 dark:hover:bg-gray-500"
        } p-2 text-center`}
