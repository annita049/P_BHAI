...
export function NavbarWithSearch({logout}) {
  ...
  const navList = (
    <ul className="mt-2 mb-4 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
      ...
      >
        ...
        <a href="/student-list" className="flex items-center text-white">
          alumni
        </a>
      </Typography>
      <Typography
      ...
      >
        ...
        <a href="create-post" className="flex items-center text-white">
          create post
        </a>
      </Typography>
    </ul>
  ...
  return (
    <Navbar className="bg-[#212121] text-white mx-auto max-w-screen-xl px-4 py-2 lg:px-8 lg:py-4">
      ...
      <MobileNav open={openNav}>
        <div className="container mx-auto">
          ...
          <div className="flex flex-col gap-x-2 sm:flex-row sm:items-center">
            ...
            <Button size="md" className="mt-1 rounded-lg sm:mt-0 text-white">
              Search
            </Button>
          </div>
        </div>
